...
# ---------------------------------------------------------------------------
M6_INITIAL   = 0.45    # Startwert für den ersten Betriebspunkt
...
def plot_results(results: dict[float, dict]) -> None:
    ...
    fig1.tight_layout()
    plt.savefig("Auswertung_KO/Results_Plots/AHT_UA_LMTD_Performance.png", dpi=150, bbox_inches="tight")
    ...
    fig2.tight_layout()
    plt.savefig("Auswertung_KO/Results_Plots/AHT_UA_LMTD_Exergy.png", dpi=150, bbox_inches="tight")
    ...
    fig3.tight_layout()
    plt.savefig("Auswertung_KO/Results_Plots/AHT_UA_LMTD_mass_flow_opt.png", dpi=150, bbox_inches="tight")
