...
def plot_results(results: dict[float, dict]) -> None:
    ...
    fig1.tight_layout()
    plt.savefig("Auswertung_KO/Results_Plots/AHT_UA_LMTD_Performance_ref.png", dpi=150, bbox_inches="tight")
    ...
    fig2.tight_layout()
    plt.savefig("Auswertung_KO/Results_Plots/AHT_UA_LMTD_Exergy_ref.png", dpi=150, bbox_inches="tight")
    ...
    fig3.tight_layout()
    plt.savefig("Auswertung_KO/Results_Plots/AHT_UA_LMTD_mass_flow_opt_ref.png", dpi=150, bbox_inches="tight")
