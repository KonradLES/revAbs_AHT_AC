...
SCAN_CONFIG = {
    ...
    "T_cond_in": dict(
        min_C=10.0, max_C=48.0, start_C=20.0,
...
def plot_results(results: dict[float, dict]) -> None:
    ...
    fig1.tight_layout()
    plt.savefig("Auswertung_KO/Results_Plots/AHT_Pinch_Point_Performance.png", dpi=150, bbox_inches="tight")
    ...
    fig2.tight_layout()
    plt.savefig("Auswertung_KO/Results_Plots/AHT_Pinch_Point_Exergy.png", dpi=150, bbox_inches="tight")
    ...
    fig3.tight_layout()
    plt.savefig("Auswertung_KO/Results_Plots/AHT_Pinch_Point_mass_flow_opt.png", dpi=150, bbox_inches="tight")
